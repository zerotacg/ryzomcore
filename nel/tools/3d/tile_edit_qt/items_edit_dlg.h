...
public:
    static QStringList getItems(QWidget *parent, const QString &title, const QString &label, const QStringList &availablelist, const QStringList &selectedlist, bool *ok = 0);
...
private:	
	explicit CItems_edit_dlg(QWidget *parent = 0);
