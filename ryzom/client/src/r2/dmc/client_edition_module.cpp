...
void CClientEditionModule::onModuleUp(TModuleProxyPtr moduleProxy)
{
...
void CClientEditionModule::onModuleDown(TModuleProxyPtr moduleProxy)
{
...
bool CClientEditionModule::onProcessModuleMessage(TModuleProxyPtr senderModuleProxy, const CMessage &message)
{
