...
namespace MFS
{
	...
	private:
		...
		typedef void (CMailForumNotifierSkel::*TMessageHandler)(NLNET::TModuleProxyPtr sender, const NLNET::CMessage &message);
	...
	public:
		CMailForumNotifierProxy(NLNET::TModuleProxyPtr proxy)
		{
