...
namespace CMDEXE
{
	...
	private:
		...
		typedef void (CCommandExecutorSkel::*TMessageHandler)(NLNET::TModuleProxyPtr sender, const NLNET::CMessage &message);
	...
	public:
		CCommandExecutorProxy(NLNET::TModuleProxyPtr proxy)
		{
