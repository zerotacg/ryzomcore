...
{		
	...
	protected:
		...
		void cbFileInfo(NLNET::TModuleProxyPtr sender, const TFileInfoVector &files) NL_OVERRIDE;
		...
		void cbFileDataFailure(NLNET::TModuleProxyPtr sender, const std::string &fileName) NL_OVERRIDE;
